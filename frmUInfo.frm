...
Begin VB.Form frmUInfo 
   ...
   Begin VB.Image Image1 
      Height          =   480
      Left            =   90
      Picture         =   "frmUInfo.frx":08CA
      Top             =   105
      Width           =   480
   End
End
Attribute VB_Name = "frmUInfo"
...
Public Sub ShowUI(ByVal UID2 As Long)
On Error Resume Next
UID = UID2
lblNick = Replace(Cone(UID).Name, vbNullChar, "")
lblIP = Cone(UID).IP
lblPort = frmServer.Connector(UID).RemotePort
End Sub
